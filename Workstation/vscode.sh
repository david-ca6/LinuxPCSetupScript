...
flatpak run com.visualstudio.code --install-extension ms-azuretools.vscode-docker
flatpak run com.visualstudio.code --install-extension GitHub.remotehub
flatpak run com.visualstudio.code --install-extension znck.grammarly
...
flatpak run com.visualstudio.code --install-extension WakaTime.vscode-wakatime
